...
Territory.prototype = {
     ...
     * @param {{index: string, title: string, lng: string, lat: string, sensors: Array.<{id: string, name: string, lng: string, lat: string, time: string, value: string}>}} rawData Fresh piece of JSONified XML data from server
     * @private
     */
